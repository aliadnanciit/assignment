...
import com.assignment.databinding.FragmentMainWeatherBinding
...
class MainWeatherFragment : Fragment(), CityOnclickListener {
    ...
    private fun updateTodayWeatherView(it: com.assignment.model.UserWeatherState<com.assignment.model.WeatherResponseData>?) {
        it?.let { userWeatherState ->
            ...
            when (userWeatherState) {
                is com.assignment.model.UserWeatherState.Success -> {
                    updateUserLocationCard(userWeatherState.results)
                    viewModel.scheduleNotification(userWeatherState.results.name)
                }
                is com.assignment.model.UserWeatherState.Error -> {

                }
                is com.assignment.model.UserWeatherState.Loading -> {
                    binding.userWeatherLoading.visibility = View.VISIBLE
                }
                is com.assignment.model.UserWeatherState.PermissionRequired -> {
    ...
    private fun updateUserLocationCard(response: com.assignment.model.WeatherResponseData) {
